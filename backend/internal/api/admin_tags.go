...
func (a *AdminServer) handleUpdateTag(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil || id <= 0 {
		writeErr(w, r, http.StatusBadRequest, errors.New("invalid tag id"))
		return
	}
...
func (a *AdminServer) handleStartTagRetag(w http.ResponseWriter, r *http.Request) {
	if a.OnStartTagRetag == nil {
		writeErr(w, r, http.StatusNotImplemented, errors.New("tag maintenance is not configured"))
		return
	}
...
func (a *AdminServer) handleTagJobStatus(w http.ResponseWriter, r *http.Request) {
